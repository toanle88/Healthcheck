      ...
      <div className="fixed top-6 right-6 z-50 flex flex-col gap-3 w-full max-w-sm pointer-events-none">
        {toasts.map((t) => {
          ...
          if (t.type === 'success') {
            ...
            typeClass = 'bg-red-500/10 border-red-500/20 text-red-400';
          }

          return (
            <div
              key={t.id}
              className={`pointer-events-auto flex items-start gap-3 p-4 rounded-2xl border backdrop-blur-xl shadow-lg transition-all duration-300 animate-in slide-in-from-right-5 fade-in ${typeClass}`}
            >

...
func TestStoreIntegration(t *testing.T) {
	...
	var insertedTarget Target

	t.Run("InsertTargetAndChecks", func(t *testing.T) {
		// Insert target first, so GetLatestChecks finds it
		_, err = st.InsertTarget(ctx, InsertTargetParams{
	...
	t.Run("InsertAlertTarget", func(t *testing.T) {
		// 7. Test InsertTarget
		var err error
		insertedTarget, err = st.InsertTarget(ctx, InsertTargetParams{
	...
	t.Run("UpdateTargetAlertStateTransitions", func(t *testing.T) {
	...
	t.Run("GetTargetsAndHistory", func(t *testing.T) {
		// 8b. Test GetTargets
	...
	t.Run("DeleteAndCleanup", func(t *testing.T) {

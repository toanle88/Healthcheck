...
resource "azurerm_postgresql_flexible_server" "main" {
  #checkov:skip=CKV2_AZURE_57:Flexible Server uses native VNet Integration (delegated subnet) which provides complete private network access.
  ...
  # Enable geo-redundant backups for production (CKV_AZURE_136)
